...
In other cases where the game is not a source mod, you must either run the main executable, use a cracked executable, or run with the command line options that can be found in the opensteamworks CDR database (http://cdr.thebronasium.com/)
...
EXTERNAL SOURCES:
steampowered.com
cs.rin.ru (steam underground)
rinru.us.to (steam underground cache files)
rev-crew.info (rev crew forums)
bir3yk.net (rev crew home)
cdr.thebronasium.com (opensteamworks CDR database)
